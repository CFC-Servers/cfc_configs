{
  whitelist_globals: {
    ...
    "CurTime", "DamageInfo", "DebugInfo", "DeriveGamemode",
    "Derma_Anim", "Derma_DrawBackgroundBlur", "Derma_Hook", "Derma_Install_Convar_Functions",
    "Derma_Message", "Derma_Query", "Derma_StringRequest", "DermaMenu",
    "DisableClipping", "DOF_Kill", "DOF_Start", "DOFModeHack",
    "DrawBackground", "DrawBloom", "DrawColorModify", "DrawMaterialOverlay",
    "DrawMotionBlur", "DrawSharpen", "DrawSobel", "DrawSunbeams",
    "DrawTexturize", "DrawToyTown", "DropEntityIfHeld", "DynamicLight",
    "EffectData", "Either", "EmitSentence", "EmitSound",
    "EndTooltip", "Entity", "error", "ErrorNoHalt",
    "EyeAngles", "EyePos", "EyeVector", "FindMetaTable",
    "FindTooltip", "Format", "FrameNumber", "FrameTime",
    "GameDetails", "gcinfo", "GetConVar", "GetConVar_Internal",
    "GetConVarNumber", "GetConVarString", "GetDefaultLoadingHTML", "GetDemoFileDetails",
    "GetDownloadables", "getfenv", "GetGlobalAngle", "GetGlobalBool",
    "GetGlobalEntity", "GetGlobalFloat", "GetGlobalInt", "GetGlobalString",
    "GetGlobalVector", "GetHostName", "GetHUDPanel", "GetLoadPanel",
    "GetLoadStatus", "GetMapList", "getmetatable", "GetOverlayPanel",
    "GetRenderTarget", "GetRenderTargetEx", "GetSaveFileDetails", "GetViewEntity",
    "HSLToColor", "HSVToColor", "HTTP", "include",
    "IncludeCS", "ipairs", "isangle", "isbool", "IsColor",
    "IsEnemyEntityName", "IsEntity", "IsFirstTimePredicted",
    "IsFriendEntityName", "isfunction", "IsInGame", "ismatrix",
    "IsMounted", "isnumber", "ispanel", "isstring",
    "istable", "IsTableOfEntitiesValid", "IsUselessModel", "IsValid",
    "isvector", "JoinServer", "JS_Language", "JS_Utility",
    "JS_Workshop", "Label", "LanguageChanged", "Lerp",
    "LerpAngle", "LerpVector", "LoadLastMap", "LoadPresets",
    "Localize", "LocalPlayer", "LocalToWorld", "Material",
    "Matrix", "Mesh", "Model", "module",
    "Msg", "MsgAll", "MsgC", "MsgN",
    "NamedColor", "newproxy", "next", "NumDownloadables",
    "NumModelSkins", "OnModelLoaded", "OpenFolder", "OrderVectors",
    "pairs", "Particle", "ParticleEffect", "ParticleEffectAttach",
    "ParticleEmitter", "Path", "pcall", "Player",
    "PositionSpawnIcon", "PrecacheParticleSystem", "PrecacheScene", "PrecacheSentenceFile",
    "PrecacheSentenceGroup", "print", "PrintMessage", "PrintTable",
    "ProjectedTexture", "ProtectedCall", "RandomPairs", "rawequal",
    "rawget", "rawset", "RealFrameTime", "RealTime",
    "RecipientFilter", "RecordDemoFrame", "RegisterDermaMenuForClose", "RememberCursorPosition",
    "RemoveTooltip", "RenderAngles", "RenderDoF", "RenderStereoscopy",
    "RenderSuperDoF", "require", "RestoreCursorPosition", "RunConsoleCommand",
    "RunGameUICommand", "RunString", "RunStringEx", "SafeRemoveEntity",
    "SafeRemoveEntityDelayed", "SaveLastMap", "SavePresets", "ScreenScale",
    "ScrH", "ScrW", "select", "SendUserMessage",
    "ServerLog", "SetClipboardText", "setfenv", "SetGlobalAngle",
    "SetGlobalBool", "SetGlobalEntity", "SetGlobalFloat", "SetGlobalInt",
    "SetGlobalString", "SetGlobalVector", "setmetatable", "SetPhysConstraintSystem",
    "SortedPairs", "SortedPairsByMemberValue", "SortedPairsByValue", "Sound",
    "SoundDuration", "SQLStr", "SScale", "STNDRD",
    "SuppressHostEvents", "SysTime", "TauntCamera", "TextEntryLoseFocus",
    "TimedCos", "TimedSin", "tobool", "ToggleFavourite",
    "tonumber", "tostring", "TranslateDownloadableName", "type",
    "TypeID", "unpack", "UnPredictedCurTime", "UpdateLoadPanel",
    "UTIL_IsUselessModel", "ValidPanel", "Vector", "VectorRand",
    "VGUIFrameTime", "VGUIRect", "VisualizeLayout", "WorkshopFileBase",
    "WorldToLocal", "xpcall",
